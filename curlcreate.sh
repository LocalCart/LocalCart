...
curl -X POST -H "Content-Type: application/json" --data '{"inventoryID": 2, "name" : "Blue Ballpoint Pen", "description" : "Great writing utensil", "price" : 100}' https://fierce-island-3989.herokuapp.com/api/item/create

curl -X POST -H "Content-Type: application/json" --data '{"inventoryID": 2, "name" : "Black Ballpoint Pen", "description" : "Great writing utensil", "price" : 1000}' https://fierce-island-3989.herokuapp.com/api/item/create

curl -X POST -H "Content-Type: application/json" --data '{"inventoryID": 2, "name" : "Red Ballpoint Pen", "description" : "Great writing utensil", "price" : 10000}' https://fierce-island-3989.herokuapp.com/api/item/create

curl -X POST -H "Content-Type: application/json" --data '{"inventoryID": 2, "name" : "Red Marker", "description" : "Great for telling people what they did wrong", "price" : 5}' https://fierce-island-3989.herokuapp.com/api/item/create
